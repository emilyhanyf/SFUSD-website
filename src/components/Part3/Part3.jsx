...
const screens = [
  ...
  { id: 3, value: getImageUrl("part3/screen6.png") },
];

const goalScreens = [
  { id: 4, value: getImageUrl("part3/screen3.png") },
  { id: 5, value: getImageUrl("part3/screen4.png") },
  { id: 6, value: getImageUrl("part3/screen5.png") }
];
...
export const Part3 = () => {
  ...
  return (
    <section className={styles.backgroundImage}>
      {screenData.id < 4 && (
        <>
          <button className={`${styles.btn} ${styles.homeButton}`} onClick={goHome}>
            <img src={getImageUrl("part3/homeIcon.png")} alt="Home" className={styles.icon} />
          </button>
      ...
      {(screenData.id > 3 && screenData.id < 7) && (
        <>
          <button className={`${styles.btn} ${styles.homeButton}`} onClick={goBackToGoal}>
      ...
      {screenData.id > 6 && (
        <>
          <button className={`${styles.btn} ${styles.homeButton}`} onClick={goBackToProposal}>
            <img src={getImageUrl("part2/leftArrow.png")} alt="Back" className={styles.icon}/>
          </button>
        </>
      )}
